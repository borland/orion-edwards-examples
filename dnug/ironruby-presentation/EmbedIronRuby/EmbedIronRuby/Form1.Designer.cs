namespace EmbedIronRuby
{
	partial class Form1
	{
		...
		private void InitializeComponent()
		{
			...
			this.label1.Text = "This is our main application which will do lots of important stuff";
			// 
			// button1
			// 
			...
			this.button1.Text = "Click me to start the interactive ruby console!";
